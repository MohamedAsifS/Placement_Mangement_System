...
<a href="index.php">
    <img src="kct1.jpeg" alt="" height=90px>
        ...
        <nav>
          <ul class="nav-list">
            <li class="active">
              <a href="adminpage.php" aria-current="page">ADDING CREDENTIALS</a>
            </li>
...
if (mysqli_connect_error()){
    ...
    $SELECT = "SELECT email From adadduser Where email = ? Limit 1";
    $INSERT = "INSERT Into adadduser (email,pass )values(?,?)";
